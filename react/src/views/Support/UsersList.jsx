      ...
      if (user.length === 0) {
        return (
          <div className="flex items-center justify-center space-x-2 mt-12">
            <p className='font-bold'>Pas encore d'utilisateurs</p>
          </div>
        );
      }
...
<div class="mx-auto max-w-3xl">
  ...
  <table class="w-full bg-white shadow-md rounded mb-4">
    <thead class="bg-gray-200">
      <tr>
        ...
        <th class="px-4 py-2 text-left text-gray-600">Pays</th>
        <th class="px-4 py-2 text-left text-gray-600">Société</th>
  ...
  {user.map((user) => (
    <tr key={user.id}>
      ...
      <td class="border px-4 py-2 text-gray-600">{user.name}</td>
      <td class="border px-4 py-2 text-gray-600">{user.email}</td>
      <td class="border px-4 py-2 text-gray-600">{user.phone && user.phone}</td>
      <td class="border px-4 py-2 text-gray-600">{user.country && user.country}</td>
      <td class="border px-4 py-2 text-gray-600">{user.company && user.company}</td>

      
      <td class="border px-4 py-2 text-gray-600">
      <div className='flex'>
          <Link to="/showteam" type="button" className=" hover:bg-blue-200 text-white  py-1 px-1 rounded " >
          ...
          <Link to="/editteam" type="button" className=" hover:bg-green-200 text-white  py-1 px-1 rounded " >
          ...
          <button type="button" className=" hover:bg-red-500 text-white  py-1 px-1 rounded" onClick={() => handleDelete(user.id)}>
            <svg height="20px"
