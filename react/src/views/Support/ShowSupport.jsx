  ...
  return (
    <div>
      ...
      <div className="bg-gray-100 rounded-md p-4 m-4">
        <h3 className="font-bold text-lg text-center ">{support.name}
      ...
      <div className="flex items-center justify-between mb-4">
          ...
          <div>{support.id && support.id}</div>
        </div>
        <div className="flex items-center justify-between mb-4">
          <div className="font-bold">NOM</div>
          <div>{support.name && support.name}</div>
        </div>
        <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div>{support.team && support.team}</div>
        </div>
        ...
        <div className="flex items-center justify-between mb-4  ">
          ...
          <div>{new Date(support.created_at).toLocaleString()}</div>
        </div>
