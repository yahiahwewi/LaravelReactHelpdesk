...
function handleUpdate() {
    axiosClient.put(`/UpdateTeam/${team.id}`, {
      title: title,
  ...
  return (
    <div>
      ...
      <div className="bg-gray-100 rounded-md p-4 m-4">
        <h3 className="font-bold text-lg text-center ">{team.title}</h3>
      </div>
      <div className="p-4">
        <div className="flex items-center justify-between mb-4">
          <div className="font-bold">NOM</div>
          <input  className="w-64 px-4 py-2 rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
...
></input>
        ...
        <div className="flex items-center justify-between mt-6">
          ...
          <textarea  defaultValue={team.description && team.description} 
       onChange={handleDescriptionChange}
       className="w-64 px-4 py-2 rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500 mt-6"
>
          </textarea>
        </div>
        <div className="flex items-right justify-between">
          <div className="font-bold">DATE DE CRÉATION</div>
          <div className="w-64 px-4 py-2 rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">{new Date(team.created_at).toLocaleString()}</div>
        </div>
      </div>
