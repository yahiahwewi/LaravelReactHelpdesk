  ...
  const handleDelete = (id) => {
    ...
    if (confirmed) {
      axiosClient.delete(`/deleteuser/${id}`)
        .then(() => {
          // handle success
          setSupport(support.filter(support => support.id !== id));
        })
        .catch(() => {
          // handle error
        });
    ...
    <div>
      ...
      <div class="flex flex-col ">
        ...
        <div class="py-2    sm:px-6 lg:px-8  ">
          <Link to="/my">
            <a href="/" className=" top-2 left-2 flex-none">
              <svg
                fill="#68ea39"
                height="50px"
                width="50px"
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {support.map((support, index) => (
                  <tr key={support.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{support.id}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{support.name}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{support.email}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{support.phone}</td>
                    {/* <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{support.department}</td> */}
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{support.country}</td>
                    <div className='flex ml-6 mt-4'>
             <Link to={`/showsupport/${support.id}`} type="button" className=" hover:bg-blue-200 text-white  py-1 px-1 rounded " >
          ...
          <Link to={`/editsupport/${support.id}`}type="button" className=" hover:bg-green-200 text-white  py-1 px-1 rounded " >
          ...
          <button type="button" className=" hover:bg-red-500 text-white  py-1 px-1 rounded" onClick={() => handleDelete(support.id)}>
            <svg height="20px"
