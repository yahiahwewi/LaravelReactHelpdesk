...
<div  className=" m-16 block h-full p-8 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
    ...
    <p className=" text-xl text-center font-bold tracking-tight text-gray-900 dark:text-white">Assistance :</p>
    ...
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlSpace="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enableBackground="new 0 0 1000 1000" >
...
>
  ...
  <small className="absolute top-7 right-0 px-2 py-1  hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
 {ticket.step}
  </small>
</Link>
))
